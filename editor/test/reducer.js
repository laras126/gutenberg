...
describe( 'state', () => {
	...
	describe( 'blockSelection()', () => {
		it( 'should return with block uid as selected', () => {
			...
			expect( state ).toEqual( { start: 'kumquat', end: 'kumquat', focus: {}, isMultiSelecting: false, isSelectionEnabled: true } );
		} );
		...
		it( 'should update the focus and selects the block', () => {
			...
			expect( state ).toEqual( { start: 'chicken', end: 'chicken', focus: { editable: 'citation' }, isMultiSelecting: false, isSelectionEnabled: true } );
		} );
